...
public class AlarmActivityTest extends
	ActivityInstrumentationTestCase2<AlarmActivity> {
    private Solo solo;
	...
	solo.clickOnText(solo
		.getString(com.yp2012g4.vision.R.string.setAlarmButton));
	solo.assertCurrentActivity("wrong activity", SetClockActivity.class);
	assertTrue(solo.waitForText(solo
		.getString(com.yp2012g4.vision.R.string.setHour)));
	solo.clickOnScreen(50, 50);
	solo.assertCurrentActivity("wrong activity", SetClockActivity.class);
	assertTrue(solo.waitForText(solo
		.getString(com.yp2012g4.vision.R.string.setMinutes)));
	flingUp();
	flingUp();
	solo.clickOnScreen(50, 50);
	solo.assertCurrentActivity("wrong activity", AlarmActivity.class);
	solo.clickOnText(solo
		.getString(com.yp2012g4.vision.R.string.startAlarm));
    }
	...
	TouchUtils.drag(this, screenWidth / 2, screenWidth / 2,
		screenHeight / 2, screenHeight / 2 - 10, 5);
    }
}
