  ...
  public void onClick(View v) {
    switch (v.getId()) {
      case R.id.button_getBatteryStatus:
        speakOut(((TalkingImageButton) v).getReadText().toString() + "is " + _battery + "% " + getChargeStatus(_status));
        break;
      case R.id.button_getReceptionStatus:
        speakOut(((TalkingImageButton) v).getReadText().toString() + "is" + signalToPercent(_signal) + "%");
        break;
      default:
        break;
    }
