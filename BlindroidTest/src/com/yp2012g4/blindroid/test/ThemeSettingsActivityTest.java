 ...
 * @version 1.0
 */
public class ThemeSettingsActivityTest extends
		ActivityInstrumentationTestCase2<ThemeSettingsActivity> {
	private Solo solo;
	private Activity activity;

	
	public ThemeSettingsActivityTest() {
		super("com.yp2012g4.blindroid", ThemeSettingsActivity.class);
	}
