...
public class SoftKeyboard extends InputMethodService implements
	...
	// mTts = new TextToSpeechBeta(this, null);
    }
	...
	case InputType.TYPE_CLASS_TEXT:
		...
		// If this is an auto-complete text view, then our
		// predictions
	...
	if (mCompletionOn) {
		...
		final CompletionInfo ci = completions[i];
	...
	final Keyboard currentKeyboard = mInputView.getKeyboard();
	...
	if (mCompletionOn && mCompletions != null && index >= 0
	    ...
	    final CompletionInfo ci = mCompletions[index];
    ...
    /*
     * public void onComputeInsets(Insets outInsets) { View decor =
     * getWindow().getWindow().getDecorView(); outInsets.visibleTopInsets =
     * decor.getHeight(); //0; outInsets.contentTopInsets = 0;
     * //decor.getHeight(); outInsets.touchableInsets =
	...
	ei.imeOptions = InputType.TYPE_NULL;
