 ...
 * color in the Speaking Clock activity remains unchanged.
 * 
 * @author Maytal
 * @version 1.1
 * 
...
public class bugTextColorUnchanged extends ActivityInstrumentationTestCase2<MainActivity> {
  ...
  /*
   * Reproducing the bug: 1. Run the application 2. Go to Display Settings. 3.
   * Go to Color settings. 4. Choose "White & Green". 5. Go to Main Screen. 6.
   * Go to Speaking Clock. 7. Click the "Home" button. 8. Go to Display
   * Settings. 9. Go to Color Settings. 10. Choose "Red & Black". 11. Go to Main
   * Screen. 12. Go to "Speaking Clock".
   * 
